...
import 'package:fastfood/Models/FoodsModel.dart';
import 'dart:convert' show json, base64, ascii;
import 'package:http/http.dart' as http;
import 'package:fastfood/Screens/detail/details.dart';
import 'package:fastfood/Screens/menu/draw_menu.dart';
import 'package:fastfood/core/const/border/border_radi.dart';
import 'package:fastfood/core/const/enums/icon_enums/icon_enums.dart';
import 'package:fastfood/core/const/responsive/responsive.dart';
...
import 'package:fastfood/core/widget/nullData/null_data_widget.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  late var foodslist = fetchFood(pageCount);
  @override
  void initState() {
  ...
  Future<List<Foods>> fetchFood(int pageCount) async {
    final response = await http.get(
      Uri.parse('http://192.168.242.1:3000/foods?page=$pageCount'),
    );
